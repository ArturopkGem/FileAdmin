...
**Salida esperada:**
```
Alumno{matricula='3466', nombre='Diego', promedio=9.0}
```
...
=== LISTA DE ALUMNOS ===
Alumno{matricula='5799', nombre='Sergio', promedio=9.7}
Alumno{matricula='3466', nombre='Diego', promedio=9.0}
Alumno{matricula='2388', nombre='Fernando', promedio=8.5}
Alumno{matricula='2388', nombre='Jaime', promedio=10.0}
Alumno{matricula='1122', nombre='Ana', promedio=9.3}
```
...
├── 📄 Act_alumnos.txt      → Contiene los métodos
└── 📄 Main.java            →  main
```
...
public class Main {
    ...
    // Aquí van los métodos: escribirAlumnos, leerAlumnos,
    // buscarAlumnoPorMatricula y agregarAlumno
}
```
